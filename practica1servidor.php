...
<html>
    ...
    <body>
        <h1> Inserción de código en páginas web</h1>
...
print_r($vector);
 ...
 $flag = false;
 echo $flag; //no se muestra porque el valor false de un boolean corresponde al valor null en php.  

 echo "<br>";
 echo "<b>Ejercicio 3</b><br>";
 $nuevo = str_replace(' ', '', $concatenar);
 echo $nuevo;
...
$soloconsonantes = str_replace($vocales, "", $concatenar);
...
echo intval($concatenar) . "<br> Función que devuelve el valor entero de var en caso de éxito, o 0 en caso de error. En este caso es error por eso obtenemos un 0."; //El valor entero de var en caso de éxito, o 0 en caso de error. En este caso es error por eso obtenemos un 0.
...
echo "<b>d)</b> " . "Maximo común divisor: " . MCD(4,8);
         ?>
    </body>
</html>